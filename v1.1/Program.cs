...
class Program
{
    static void Main(string[] args)
    {
        ...
        Console.Clear();
        Console.Title = "Darts Checkout Generator - v1.1 (powered by Dave Summer)";

        List<int> invalidScores = new List<int> { 169, 168, 166, 165, 163, 162, 159 };
        ...
        for (int round = 1; round < 101; round++)
        {
            ...
            } while(!invalidScores.Contains(checkoutScore));
            ...
            if(checkoutScore < 41)
            {
                Console.WriteLine("Did you check out in 3 darts? y/n");
                ...
                {
                    Console.WriteLine("This isn't a proper option! Try again!");
                    ifHit = Convert.ToChar(Console.ReadLine());
            ...
            {
                Console.WriteLine("Did you check out in 6 darts? y/n");
                ifHit = Convert.ToChar(Console.ReadLine());
            ...
            {
                Console.WriteLine("Did you check out in 9 darts? y/n");
                ifHit = Convert.ToChar(Console.ReadLine());
            ...
            if(round == 100)
            {
                performance = hit / round;
                Console.WriteLine("Round: " + round + " | hit: " + hit + " | missed: " + miss + " | performance");
    ...
    static void SuggestCheckout(int number)
    {
        ...
        if (number == 170)
            ...
            Console.WriteLine("T20, T11, Bull");
        else if (number == 120)
